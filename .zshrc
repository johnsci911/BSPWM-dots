...
alias server-up="cd $HOME/Documents/www/laradock;docker-compose up -d nginx apache2 mysql phpmyadmin redis"
alias server-build="cd $HOME/Documents/www/laradock;docker-compose up -d nginx apache2 mysql phpmyadmin redis --build"
